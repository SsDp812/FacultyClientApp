package org.example.AppWindows.FacultyWindows;
...
public class FacultyWindow extends StandartWindow {
    ...
    public FacultyWindow(String title, JFrame backFrame) {
        ...
        thisFrame = this;
        changePanel = new ChangePanel(this,"faculty");
    ...
    class loadListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                Faculty[] faculties = service.getAllFaculties();



                String[][] data = new String[faculties.length][4];


                for(int i = 0; i < data.length;i++){
                    data[i] = InfoSplitter.splitInfo(faculties[i].toString());
                    System.out.println(faculties[i].toString());
                }

                String[] cols = new String[]{"Id","Name","Description","Dean"};
