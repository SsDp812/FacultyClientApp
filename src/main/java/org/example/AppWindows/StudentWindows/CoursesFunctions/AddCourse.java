...
public class AddCourse extends StandartWindow {
    private JTextField idStudentField;
    private JTextField idCourseField;
    private JButton subbmit;
    public AddCourse(String title, JFrame backFrame) {
    ...
    class subListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                service.addCourse(Long.parseLong(idStudentField.getText()),Long.parseLong(idCourseField.getText()));
